...
def main(cfg: DictConfig):
    ...
    styles = [
        ...
        {"name": "Пламя гнева",
         ...
         "negative": NEGATIVE_BOOST + ", deformed, melting, two heads, double head, duplicate head"},
        {"name": "Ночной охотник",
         "prompt": f"single mybudgiee budgie, shadows, misterious, deep purple and black feathers, {ANATOMY_BOOST}, {UNIVERSAL_POSITIVE}",
         "negative": NEGATIVE_BOOST },
        {"name": "Утренняя роса",
         "prompt": f"single mybudgiee budgie, soft green and blue feathers, water texture, centered, {ANATOMY_BOOST}, {UNIVERSAL_POSITIVE}",
        ...
        {"name": "Валентинов день",
         ...
         "negative": NEGATIVE_BOOST + ", alone, merged, conjoined"},
